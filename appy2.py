...
def get_data():
    # CORREÇÃO AQUI: Tirei o loop de 3 tentativas para evitar o TIMEOUT do servidor
    try:
        hoje = datetime.today()
        ...
        pass # Se der erro, segue a vida retornando vazio pra nao travar
...
if df.empty:
    ...
    # Adicionei um botão pra facilitar a vida do usuario
